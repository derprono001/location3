                ...
                { this.state.loggedin == true ? (
                    ...
                    <View style={{height: 70, paddingTop: 30, backgroundColor: 'White', borderColor: 'lightgrey', borderBottomWidth: 0.5, justifyContent: 'center', alignItems: 'center'}}>
                        ...
                        <View style={{alignItems: 'center', justifyContent:'center', paddingBottom: 10, borderBottomWidth: 1}}>
                            <TouchableOpacity onPress = { () => this.setState({edittingProfile: false})}>
                        ...
                        style={{backgroundColor: 'grey', marginTop: 5, marginHorizontal: 40, paddingVertical: 20, borderRadius: 20, borderColor: 'grey', borderWidth: 1.5}}>
                            <Text style={{textAlign:'center', color: 'white'}}>Upload New Feed</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                        onPress={() => this.editProfile()}
                        style={{marginTop: 5, marginHorizontal: 40, paddingVertical: 10, borderRadius: 20, borderColor: 'grey', borderWidth: 1.5}}>
